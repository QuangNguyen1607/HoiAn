...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl">
	...
	<xsl:template match="/ProductDetail">
				...
				<div class="wrap-box-flex">
					...
					<div class="box-content">
						...
						<div class="wrap-dat-xe">
							<!-- <strong>
								<xsl:value-of disable-output-escaping="yes" select="/ProductDetail/BookAcar"></xsl:value-of>
							</strong> -->
							<a class="button-readmore" href="/dat-tour">
			...
			<section class="home-3 slide-product-main">
				<div class="container">
					<div class="wrap-title-main">
						...
						<div class="desc-title">Khám phá ngay!</div>
					</div>
					<div class="wrap-slide">
						<div class="swiper-container">
							<div class="swiper-wrapper">
		...
		<xsl:if test="count(ProductOther)&gt;0">
			<section class="page-hoat-dong-khac-main small-section">
				<div class="container">
					<div class="title-product">
						<xsl:value-of disable-output-escaping="yes" select="/ProductDetail/otherActivities"></xsl:value-of>
					</div>
	...
	<xsl:template match="NewsRelated">
		<section class="page-gallery-main small-section" setBackground="/Data/Sites/1/media/bg-map-main.png">
			<div class="container">
				<div class="title-product">
					<xsl:value-of select="Title" disable-output-escaping="yes"></xsl:value-of>
					<xsl:value-of select="EditLink" disable-output-escaping="yes"></xsl:value-of>
